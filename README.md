...
**MATH MAGICIANS** is a project do math calculations  after they visit the web app.
...
```sh
  cd my-folder
  git clone git@github.com:MPDADDY/math_magicians.git
```
...
Feel free to check the [issues page](https://github.com/MPDADDY/math_magicians/issues).
